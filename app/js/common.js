var block            		= document.getElementsByClassName('game_block');
	...
	player          		= crosses;
	stub					= " stub ";
	path1					= '<path fill="currentColor" d="M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z" class=""> stub </path>';
	path2					= '<path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200z" class=""> stub </path>';
...
var listener = function(event) {
	...
	if(target.innerHTML !== crosses && target.innerHTML !== circles &&
		target.innerHTML !== stub && target.innerHTML !== path1 && target.innerHTM5L !== path2 && target !== game) {
...
var doReset = function clear() {
	console.log(quantity, stepCount);	
